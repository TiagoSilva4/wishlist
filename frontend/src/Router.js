...
import EditWishlist from './wishlist/EditWishlist'
import Categories from './wishlist/Categories'
...
import MyWishlists from './wishlist/MyWishlists'
  ...
  return createBrowserRouter([
    {
      ...
      children: [
        ...
        },
        {
          ...
          element: <AuthenticatedRoute><CreateWishlist /></AuthenticatedRoute>
        },
        {
          path: '/wishlist/:slug',
        ...
        },
        {
          ...
          element: <AuthenticatedRoute><EditWishlist /></AuthenticatedRoute>
        },
        {
          path: '/account/login',
        ...
        },
        {
          ...
          element: <AnonymousRoute><VerificationEmailSent /></AnonymousRoute>
        },
        {
        ...
        {
          path: '/wishlist',
          element: <AuthenticatedRoute><MyWishlists /></AuthenticatedRoute>
        },
        {
          path: '/categories',
